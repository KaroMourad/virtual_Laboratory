...
class SecondPage extends React.Component
{
	...
	setWidthHeight = () => 
	{
		if (window) 
		{
			...
			/*car coordinates*/
			this.initial_X_Car = (window_width - HEADER_WIDTH - 20) / 2;
			this.initial_Y_Car = (window_height * 7 / 10) / 2;

			/*ball coordinates*/
			this.initial_X_Circle = (window_width - HEADER_WIDTH - 20) / 4;
			this.initial_Y_Circle = (window_height * 7 / 10) / 2 + initialCarHeight / 2;
